...
function proccess()
		...
		function proccesscmp()
            ...
            jQuery('#file').bind('change', function () {
                ...
                if (fourchr == 'VCHR' || fourchr == 'MLED' || fourchr == 'MITM'|| fourchr == 'HUSK' || fourchr == 'SIBW' || fourchr == 'SALE' || fourchr == 'PURC' || fourchr == 'DXBS' || fourchr == 'DXBV' || fourchr == 'DXBP' || fourchr == 'FEES'|| fourchr == 'QHRE') {
					if (fourchr == 'VCHR' || fourchr == 'MLED' || fourchr == 'HUSK' || fourchr == 'SIBW' || fourchr == 'MITM' || fourchr == 'SALE' || fourchr == 'PURC' || fourchr == 'DXBS' || fourchr == 'DXBV' || fourchr == 'DXBP' || fourchr == 'FEES'|| fourchr == 'QHRE') {
					convert = true;
					}else {convert = false;}
	  ...
	  jQuery('#file').bind('change', function () {
                ...
                if (fourchr == 'VCHR'){
					if (isLocalEnvironment()) {
                        ...
                        myurl = "https://express_project-1-c3739639.deta.app/upload";
                    }	
				} if (fourchr == 'MLED'){
					...
					myurl = "http://localhost:5500/uploaddxb"
					
				} if (fourchr == 'DXBS'){
					myurl = "http://localhost:5500/salesdxb"
					
				}if (fourchr == 'DXBP'){
					myurl = "http://localhost:5500/purchasedxb"
...
function isLocalEnvironment() {
    // Logic to determine if the environment is local or not
    // For example, you can check the hostname or other parameters
    // You might need to adjust this logic based on your specific setup
